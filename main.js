...
var UVa={
   ...
   "Hashmat the brave warrior":{
      ...
      "ifsolve":"True",
      "link":"https://uva.onlinejudge.org/external/100/p10041.pdf",
      "how":"測資有二數字，相減即可。"
   },
   "Primary Arithmetic":{
...
function load(){
	...
	var ques={"Vito's family":"abs"};
		...
		var quearr=[];
		for(qui in UVa){
			quearr +="<p >"+qui+"</p><p>"+UVa[qui].number +"</p>";
...
function add(){	
	...
	for(ali in UVa){
		console.log(ali);
		document.getElementsByTagName("p")[intali*2].addEventListener("click", 
				function(){var view = document.getElementById("queview");
							view.innerHTML="<p>"+this.innerHTML+"s</p><p>"+UVa[this.innerHTML].how+"</p>";
							var quest = document.getElementById("quest");
							quest.innerHTML="<iframe src="+UVa[this.innerHTML].link+"></iframe>";
							console.log(UVa[this.innerHTML].link);
							});	
							intali+=1;
			}
	}
